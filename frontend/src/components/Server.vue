    ...
    <div v-if="server.tiposervidor_id==2">
        ...
        <q-card v-else class="tarjetas shadow-5">
            ...
            <div class="row">
                ...
                <div>
                    <q-list dense bordered padding style="height: 218px; border-right: none; border-bottom: none;">                   
                    <q-item-label class="label" header>Servidor</q-item-label>
                ...
                <div>
                    <q-list dense bordered padding style="height: 217px; border-right: none; ">
                    <q-item-label  class="label" header>Appserver</q-item-label>
                    <q-item clickable v-ripple>
                        <q-item-section>
                        Estado: 
                ...
                <div class="col-6">
                <div>
                    <q-list dense bordered padding style="height: 435px; border-bottom: true;">
                    <q-item-label  class="label" header>Componentes CERTA</q-item-label>
                    <q-item clickable v-ripple>
                        <q-item-section>
                            SCADA: 
    ...
    <div v-else-if="server.tiposervidor_id==3">
        ...
        <q-card class="tarjetas shadow-5" v-else>
            ...
            <div class="row">
                ...
                <div>
                    <q-list dense bordered padding style="height: 230px; width: 337px;">
                    <q-item-label  class="label" header>CROMO</q-item-label>
                    <q-item clickable v-ripple>
                        <q-item-section>
                        Instalado: 
